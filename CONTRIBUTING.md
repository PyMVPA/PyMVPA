...
- `mvpa2/` is the main Python module where major development is happening,
  with major submodules being:
    ...
    - `misc/` -
    - `sandbox/` - 
    - `support/` - various support modules, e.g. for NiPy, SciPy, NiBabel, etc.
    - `testing/` -
...
- `tools/` contains helper utilities used during development, testing, and
  benchmarking of PyMVPA.  Implemented in any most appropriate language
  (Python, bash, etc.)
