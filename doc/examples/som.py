...
The SOM will map a number of colors into a rectangular area.
"""
...
dataset. To be able to do this, we will assign an arbitrary labels. This
will not be considered at all, since this SOM mapper uses an unsupervised
training algorithm.
"""
...
tell it to train the network using 400 iterations and some learning rate.
"""
