...
data/freesurfer/
  Data used for and generated by recon-all. Only included in the tutorial_data_surf_complete archive.
  ...
  subj1
    ...
    to the current working directory (data/freesurfer).
    
    Freesurfer version: freesurfer-Linux-centos4_x86_64-stable-pub-v5.0.0
    
  subj1/surf/SUMA
    Contains the output from AFNI's @SUMA_Make_Spec_FS program that
...
suma_surfaces/
  Surfaces generated by the AFNI/SUMA wrapper script in
...
0.3*
  ...
  * Added tutorial_data_surf_{complete,minimal}-0.1.tar
    descriptions to the README file.
