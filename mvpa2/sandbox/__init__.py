...
#
### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ##
"""Stuff which is not imported into the suite and should not generally
be used since it is not yet formalized.  code should not be used
directly but if you see a fit for a specific function in your code --
just copy it to guarantee it would work with future releases.
"""
...
def _get_unique_in_axis(a, axis_=-1):
    ...
    return np.apply_along_axis(
        ...
        np.reshape(a, (-1, slmap.shape[axis_]))).T
